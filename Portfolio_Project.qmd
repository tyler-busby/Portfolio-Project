...
The above code to add an image file was modeled using a tutorial from Dean Chereden on YouTube. CSE Citation:  
...
tot_nudibranchs |>
  ...
  geom_image(aes(image = image_file),
             size = 0.16) + #insert image on each bar in the bar plot
